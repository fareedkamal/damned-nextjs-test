  ...
  return (
    ...
    >
      <div className="w-1/2 flex flex-col justify-center items-center px-10 py-5 gap-10 shadow-2xl bg-white rounded">
        <div className="flex self-end cursor-pointer" onClick={() => props.onShow(false)}>
          <svg
        ...
        <Image
          ...
          src="https://damnedventures.com/wp-content/uploads/Abandoned-Cart-Email-Large-banner-1.png"
          alt=""
          width={759}
          height={349}
        />
  ...
  return (
    <div className="flex flex-col justify-center items-center fixed top-0 left-0 w-screen h-lvh z-[50] text-center">
      ...
      <div className="w-1/4 flex flex-col justify-center items-center px-10 py-5 z-[55] gap-1 bg-white opacity-100 shadow-2xl">
        ...
        <Image
          src="https://damnedventures.com/wp-content/uploads/Asset-4-1.png"
          width={132}
          height={31}
          alt=""
        />
        ...
        <Link className="text-blue-900 pt-5" href="https://services.sheerid.com/verify/66394380141e0119a76dfaa1/?layout=landing">
          Teacher
        </Link>
        <Link className="text-blue-900 pt-5" href="https://services.sheerid.com/verify/663944c3141e0119a76e0670/?layout=landing">
          Senior
        </Link>
